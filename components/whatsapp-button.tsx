...
export function WhatsappButton() {
  return (
    <motion.a
      href={waLink("Halo Makmur Motor, saya ingin bertanya tentang mobil yang tersedia")}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Respon cepat via WhatsApp Makmur Motor"
    ...
    >
      <span className="hidden rounded-full bg-white/95 px-3 py-1.5 text-xs font-semibold text-ink shadow-lg backdrop-blur md:inline-block">
        Respon Cepat via WhatsApp
      </span>
      <span className="relative grid h-14 w-14 shrink-0 place-items-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/40">
